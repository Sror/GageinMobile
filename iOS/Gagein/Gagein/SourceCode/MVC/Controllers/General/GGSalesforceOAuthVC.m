...
- (id)init
{
    ...
    if (self) {
        ...
        _redirectURL = @"https://login.salesforce.com/services/oauth2/success";//@"testsfdc:///mobilesdk/detect/oauth/done";
...
- (void)viewDidLoad
{
    ...
    self.oauthCoordinator.scopes = [NSSet setWithObjects:@"full", @"refresh_token", nil];
