...
-(id)initWithViewControllers:(NSArray *)aViewControllers
{
    ...
    if (self)
    {
        ...
        [_normalImages addObject:[UIImage imageNamed:@"tabbar_homepage_unsel.png"]];
        [_normalImages addObject:[UIImage imageNamed:@"tabbar_category_unsel.png"]];
        [_normalImages addObject:[UIImage imageNamed:@"tabbar_cart_unsel.png"]];
        [_normalImages addObject:[UIImage imageNamed:@"tabbar_store_unsel.png"]];
        [_normalImages addObject:[UIImage imageNamed:@"tabbar_more_unsel.png"]];
        
        [_selectedImages addObject:[UIImage imageNamed:@"tabbar_homepage_sel.png"]];
        [_selectedImages addObject:[UIImage imageNamed:@"tabbar_category_sel.png"]];
        [_selectedImages addObject:[UIImage imageNamed:@"tabbar_cart_sel.png"]];
        [_selectedImages addObject:[UIImage imageNamed:@"tabbar_store_sel.png"]];
        [_selectedImages addObject:[UIImage imageNamed:@"tabbar_more_sel.png"]];
